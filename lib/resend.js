import { ObjectId } from "@/lib/mongodb"; // If your _id is a MongoDB ObjectId
...
export async function sendJobNotification(jobId) {
  ...
  // Sanitize the job data. Since sanitizeJobData expects an array, wrap jobData in an array.
